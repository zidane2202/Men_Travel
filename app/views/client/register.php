<?php $pageTitle = 'Inscription - Men Travel'; ?>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    ...
    <div class="form-container">
        ...
        <form action="/register" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="adresse" name="adresse" placeholder="Ex: Yaoundé" required>
            </div>

            <button type="submit" class="form-button">S'inscrire</button>
            <a href="/login" class="form-link">Déjà un compte ? Connectez-vous</a>
        </form>

...
// $commandeDetails est passé par le contrôleur
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <style>
        ...
        .btn-om { background-color: #f36f21; }
        .btn-momo { background-color: #ffcc00; color: #000; }
...
<body>
    <div class="payment-container">
        ...
        <div class="summary">
            <p>Voyage: <span class="voyage"><?= htmlspecialchars($commandeDetails['ville_depart']) ?> → <?= htmlspecialchars($commandeDetails['ville_arrivee']) ?></span></p>
            <p>Montant total à payer :</p>
            <div class="price"><?= number_format($commandeDetails['montant_total'], 0, ',', ' ') ?> XAF</div>
        </div>
        ...
        <div class="payment-methods">
            <form action="/payment/process" method="POST">
                <input type="hidden" name="id_commande" value="<?= $commandeDetails['id_commande'] ?>">
                <input type="hidden" name="montant" value="<?= $commandeDetails['montant_total'] ?>">

<?php 
// $chauffeurs et $vehicules sont passés par le contrôleur
...
<head>
    ...
    <style>
        /* (Le CSS est identique au fichier index.php pour la cohérence visuelle) */
        ...
        .btn-cancel { background: #6c757d; color: white; margin-right: 1rem; }
...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="form-card">
                <form action="/admin/voyages/store" method="POST">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="prix" name="prix" step="100" required min="1000">
                        </div>

                        <div class="form-group">
                            <label for="id_vehicule">Véhicule (Capacité) :</label>
                            <select id="id_vehicule" name="id_vehicule" required>
                                <option value="" disabled selected>Choisir un bus...</option>
                        ...
                        <div class="form-group">
                            ...
                            <select id="id_chauffeur" name="id_chauffeur" required>
                                <option value="" disabled selected>Assigner un chauffeur...</option>
                                <?php foreach ($chauffeurs as $c): ?>
                                    <option value="<?= $c['id_employe'] ?>">
